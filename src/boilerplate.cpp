/**
  ...
  * Boilerplate.cpp
  *
  * Boilerplat of miscellaneus Modern C++ features.
  *
  * I have the feeling that some of the C++ functionality seems superfluous but, anyway, this is what the community is pushing forward.
  *
  * -std=c++14
  **/
#include <iostream>
